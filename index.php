...
<!--<video autoplay muted loop id="myVideo">
  <source src="images/Rain_Fire.mp4" type="video/mp4">
</video>-->
<div class="login">
	<h1 STYLE="color:white; width:1000px; font-weight:bold; font-size:45px; margin-left:-300px;">VISHAVAI  VIDYANIKETAN HIGH SCHOOL <br><span class="vid"></span></h1>
  <h1><img src="images/schoollogo.png" style="height:70%; width:76%;"></h1>
    <form method="post">
