...
<!--header area end-->
	...
	<!-- main content-->
		<div class="content" id="mark">
			...
			<div class="location"><h4>Fee Payments</h4></div>                 <!-- location-->
...
<!--end of search forms-->
				...
				if($m==1)
				{
					...
					$sql = "SELECT * FROM studentfees where id='$id' And class='$class'"; //query for fecthing results from pervious fees
					$query=mysqli_query($conn,$sql);
					While($row=mysqli_fetch_array($query))
					{
					...
					if($tab==0){
						...
						$sql = "SELECT * FROM studentfees where id='$id' And class='$pclass'"; //query for fecthing pervious class dues
						$query=mysqli_query($conn,$sql);
						While($row=mysqli_fetch_array($query))
						{
					...
					<div class="detail">
						...
						<div id="myDIV">
							...
							<table style="width:60%; " class="monthwise">
								...
								if($tab==1){
									$ta=1;
									$query=mysqli_query($conn,"select * from studentfees where id='$id'");//query for fecthing results from database using id
									While($row=mysqli_fetch_array($query))
									{
			...
			<div class="payment">
				<div class="pay-content">
					...
					<img  src="../images/feelogo1.png" width="100%" style="margin-top:0px;">
						...
						<input type="hidden"  name="admnno" value="<?php echo $id;?>"><br>
				...
				if(isset($_POST['pay'])){
					...
					else if($value==1)
					{
						...
						<!-- fee receipt-->	
							...
							<div class="popup1">
							<div id="myDIV1">
	`						<img id="close" src="../images/close.png" onclick="window.location='feepayment.php'; document.body.style.overflow='visible';">
							<div class="print">
